...
public class Jokoa extends JFrame implements ActionListener{
	 ...
	 */
	public Jokoa() throws FileNotFoundException, FontFormatException, IOException {
		...
		Pika.getNirePika().addActionListener(this);
		goikoPanela.add(Pika.getNirePika(), BorderLayout.CENTER);
